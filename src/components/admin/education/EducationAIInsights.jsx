...
import { generateInsights } from './educationInsights'
...
export default function EducationAIInsights({ values }) {
    ...
    <section className="edu-glass-card p-4">
      <header className="mb-3 flex items-center gap-2">
        ...
        <div>
          ...
          <h3 className="text-sm font-semibold text-slate-100">Academic insights</h3>
        </div>
      </header>
