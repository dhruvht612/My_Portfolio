...
export default function SettingsAIInsights({ settings }) {
  const insights = generateSettingsInsights(settings)
    ...
    <section className="set-glass-card p-4">
      <header className="mb-3 flex items-center gap-2">
        ...
        <div>
          ...
          <h3 className="text-sm font-semibold text-slate-100">Workspace intelligence</h3>
        </div>
      </header>
