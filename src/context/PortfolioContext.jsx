...
export const goals = [
  { title: 'Short-Term Goals', badge: '2025-2026', icon: 'fas fa-rocket', accent: 'from-red-500/20 to-orange-500/20', bullets: ['Build and contribute to personal projects in web and app development', 'Stay current with industry trends and emerging technologies', 'Secure internship experience in software or research by 2026', 'Continue developing skills in frameworks, design, and data handling'], progressLabel: 'In Progress', progress: 45 },
  { title: 'Long-Term Goals', badge: '2026-2030', icon: 'fas fa-graduation-cap', accent: 'from-pink-500/20 to-purple-500/20', bullets: ['Contribute to innovative research and impactful real-world solutions', 'Pursue advanced education or leadership roles in technology', 'Mentor and inspire future computer scientists and developers', 'Collaborate on projects that bridge technology and social impact'], vision: 'Future Tech Leader' },
]
...
export const educationHighlights = [
  { title: 'Core Coursework', icon: 'fas fa-book-open', accent: 'from-blue-500/20 to-blue-600/20', bullets: ['Data Structures & Algorithms', 'Object-Oriented Programming', 'Database Systems & Web Dev'] },
  ...
  { title: 'Technical Growth', icon: 'fas fa-code', accent: 'from-purple-500/20 to-purple-600/20', bullets: ['8+ programming languages', 'Modern frameworks & tools', 'Version control & DevOps basics'] },
]
