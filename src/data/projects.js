...
export const projects = [
  ...
  {
    id: 'internix',
    title: 'Internix – AI Internship Copilot',
    description:
      'A React (Vite) web app that helps students discover roles, tailor resumes, track applications on a Kanban board, and manage their profile—with Clerk authentication and mock data until a real backend is connected.',
    iconClass: 'fas fa-briefcase',
    badge: { label: 'In progress', icon: 'fas fa-spinner', gradient: 'from-cyan-400 to-blue-500' },
    features: [
      'Job feed, job detail, and resume tailoring flows',
      'Application tracker Kanban with @dnd-kit',
      'Onboarding wizard and profile settings; protected routes after Clerk sign-in',
      'TanStack Query for data (mock today), Zustand for theme, board, and onboarding state',
      'Tailwind CSS, Framer Motion, shadcn-style UI (Radix + CVA), Sonner toasts',
    ],
    tech: [
      'React',
      'Vite',
  ...
  {
    id: 'connectly',
    title: 'Connectly – Real-Time Multi-Room Communication Platform',
    description:
      'A distributed real-time system for multiple concurrent clients with synchronized shared state: collaborative whiteboard, live presence, persistent chat history (JSON via Node.js fs), and file sharing—built around Socket.io event-driven rooms. Course project (CSCI 2020U, Group 53) with Ayush K. and Aaryan Kulkarni. In active development.',
    iconClass: 'fas fa-tower-broadcast',
    badge: { label: 'In progress', icon: 'fas fa-spinner', gradient: 'from-indigo-400 to-violet-500' },
    features: [
      'Multi-room chat: join/create rooms, WebSocket broadcast, many concurrent users',
      'Collaborative whiteboard: shared canvas with real-time drawing sync across clients',
      'Persistent chat history: messages saved to disk (JSON), restored on room join; survives restarts',
      'User presence: online/offline, typing, join/leave events broadcast to the room',
      'File and media sharing with metadata broadcast; local file-based storage',
      'Optional: DMs, roles (admin/moderator), kick/ban moderation tools',
    ],
    tech: ['React', 'Vite', 'Tailwind CSS', 'Node.js', 'Express', 'Socket.io', 'Howler.js', 'JavaScript', 'CSS'],
    categories: ['react', 'node', 'javascript', 'css'],
    links: { live: '#', code: '#' },
    disabled: true,
  },
]
